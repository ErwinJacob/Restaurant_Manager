    ...
    var body: some View {
        GeometryReader{ proxy in
            VStack{
                ...
                if useCase == "Takings"{
                    ExpensesSumBarView(label: "Top takings:", value: getCleanString(value: String(raport.getTopTakings())))
                        .frame(width: proxy.size.width, height: proxy.size.height*0.1)
                }
                else if useCase == "Expenses"{
                    ExpensesSumBarView(label: "Total expenses:", value: getCleanString(value: getCleanString(value: String(raport.getTotalExpenses()))))
                        .frame(width: proxy.size.width, height: proxy.size.height*0.1)

                }
                else if useCase == "Incomes"{
                    ExpensesSumBarView(label: "Total incomes:", value: getCleanString(value: getCleanString(value: String(raport.getTotalIncomes()))))
                        .frame(width: proxy.size.width, height: proxy.size.height*0.1)
